...
LOAD DATA INFILE '/slade/DBs/mysql-files/CPRD/22_002437_UniversityofExeter_patientlist_V4.txt'
INTO TABLE cprd_dementia_data.patids_with_linkage
FIELDS TERMINATED BY '\t'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(patid);

select count(*) from cprd_dementia_data.patids_with_linkage;
#461374

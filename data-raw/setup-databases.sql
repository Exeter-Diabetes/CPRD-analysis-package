...
# CREATE SCHEMA IF NOT EXISTS `cprd_dm24_data_dev` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
# CREATE SCHEMA IF NOT EXISTS `cprd_dm24_data` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;
# CREATE SCHEMA IF NOT EXISTS `cprd_dm24_analysis` DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci;

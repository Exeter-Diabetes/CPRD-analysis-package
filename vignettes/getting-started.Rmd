...
Configuration is stored in a private file in the users account on slade - which by default is named `~/.aurum.yaml`. 
...
The example above assumes all R analysis is running on Slade, as well as any database queries the R analysis entails. This may or may not be desirable, depending on what your connection to Slade is like.
...
```console
host hashbang
    HostName 144.173.6.146
    User <your exeter username>

host slade
    HostName slade.ex.ac.uk
    User <your exeter username>
